        ...
        <div className="footer-content">
          <div className="footer-column">
            ...
            <ul className="footer-list">
              <li>
                <a href="#">Cinnamon Hotels & Resorts</a>
              </li>
              <li>
          ...
          <div className="footer-column">
            <h4>Data Privary & Security Policy</h4>
            <ul className="footer-list">
              <li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-list">
              <li>
                <a href="#">Corporate Contact Information</a>
              </li>
              <li>
                <a href="#">Hotel Contact Information</a>
              </li>
            </ul>
          </div>
          <div className="footer-column">
          ...
          <div className="footer-column">
            <h4>Follow Us</h4>
            <ul className="footer-list social-icons-list">
              <li>
                <a href="#">
                  <svg
          ...
          <div className="footer-email-form">
            <h4 className="email-header">Get Cinnamon in your inbox</h4>
            ...
            <div className="rounded-checkbox" style={{ marginTop: "1rem" }}>
              <label>
                <input type="checkbox" />
                <span className="custom-checkbox"></span>
                By Checking this box, I consent to the processing of my Personal Data by Cinnamon
                for the purpose and within the Conditions set out in this form and the
              </label>
            </div>
          </div>
        </div>
